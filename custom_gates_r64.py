...
class CustomNaiveGate_Balance_SMoE(BaseGate):
    ...
    def forward(self, inp, return_all_scores=False):
        ...
        val_exp = val[non_zero_idx_2]
        val_tok_sum = val_tok.sum(dim=0)[0].item()
        val_exp_sum = val_exp.sum(dim=0)[1].item()
        ...
        num_token_choice = num_token * num_heads - num_token_expert_choice
