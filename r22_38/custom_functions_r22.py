...
def prepare_forward_expert_choice(gate, num_expert, world_size, gate_idx_exp):
    r"""
    Prepare necessary information from gate output for MoE computation.
    ...
    with torch.no_grad():
        local_expert_count = torch.zeros((num_expert,), dtype=int)
        local_expert_count[gate_idx_exp] = num_token_per_expert
