...
import tree
from custom_functions_r29 import prepare_forward, prepare_forward_expert_choice, ensure_comm
from custom_functions_r29 import MOEScatter, MOEGather
from custom_functions_r29 import AllGather, Slice
...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def forward(self, moe_inp):
        ...
        self.current_expert_range = (2, 16)
