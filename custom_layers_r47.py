...
import tree
from custom_functions_r47 import prepare_forward, prepare_forward_expert_choice ,ensure_comm
from custom_functions_r47 import MOEScatter, MOEGather
from custom_functions_r47 import AllGather, Slice
...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def forward(self, moe_inp):
        ...
        """
        # import ipdb; ipdb.set_trace()
        moe_inp_1, moe_inp_2, gate_top_k_idx_1, gate_score_1, gate_top_k_idx_2, gate_score_2, flag_1, flag_2 = self.gate(moe_inp)
        """
        ...
        if flag_1:
            ...
            moe_outp_1 = tree.map_structure(expert_combine_func, num_token, gate_top_k_idx_1, gate_score_1, moe_outp_1)
            # moe_outp_2 = tree.map_structure(bmm_func, gate_score_2, moe_outp_2)
        if flag_2:
            moe_outp_2 = tree.map_structure(bmm_func, gate_score_2, moe_outp_2)
        else: 
