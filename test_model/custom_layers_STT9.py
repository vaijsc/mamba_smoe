...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def __init__(
        ...
        self.add_params = nn.Parameter(torch.randn(1, 352, 352))  # Learnable for one batch
    ...
    def forward(self, moe_inp):
        ...
        # [8, 256, 352] x [8, 352, 252] -> [8, 256, 352] -> sigmoid for each token [256 tokens]
        # Prepare moe_inp_add with broadcasting
