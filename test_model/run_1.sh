...
python -m torch.distributed.launch --master_port 10009 --nproc_per_node=1 --use_env train_dgx.py $args #\
# > >(tee -a /home/ubuntu/workspace/MomentumSMoE/result/smoe_s.txt) 2>&1

echo "Evaluation ..."
python -m torch.distributed.launch --master_port 10009 --nproc_per_node=1 --use_env train_dgx.py $args --resume --full-eval-mode #\ 
# > >(tee -a /home/ubuntu/workspace/MomentumSMoE/result/smoe_s.txt) 2>&1
