...
from custom_layers_r66 import FMoE
from custom_layers_r66 import FMoELinear
...
class _Expert(nn.Module):
    ...
    def __init__(self, num_expert, d_model, d_hidden, activation, rank=0):
        super().__init__()
        self.htoh4 = FMoELinear(num_expert, d_model // 4, 4 * d_hidden, bias=True, rank=rank)
        self.h4toh = FMoELinear(num_expert, 4 * d_hidden, d_model //4 , bias=True, rank=rank)
