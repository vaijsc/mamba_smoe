...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def forward(self, moe_inp):
        ...
        moe_outp = moe_outp.view(batch_size, seq_length, moe_outp.size(1)) # [8, 256, 128]
        ...
        moe_inp /= norms * (1/3)  # Shape: [batch_size, seq_length, dimension]
        ...
        # 3. Multiply the input by the dot product for each token (broadcasting).
        # Resulting shape will be [batch_size, seq_length, dimension]
        moe_outp = moe_inp * dot_product
