...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def forward(self, moe_inp):
        ...
        # Normalize the tokens in-place to prevent extra memory allocation
        moe_inp.div_(norms)  # Normalize in-place

        # Scale moe_inp in-place (to avoid creating a new tensor)
        moe_inp.mul_(1/3)
