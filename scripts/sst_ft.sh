mkdir -p /root/checkpoints/sst2-m-test/

args="
--data /root/repos/SST-2-sentiment-analysis/data/ \
--data_name sst2 \
...
--batch-split 1 \
--nbatches 1000 \
--pretrained_weight /root/symmetric_copy/smoe.pt \
--checkpoint /root/checkpoints/sst2-m-test/smoe.pt \
--resume 
"
# --wandb-flag \
