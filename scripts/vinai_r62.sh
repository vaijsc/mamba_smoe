#!/bin/bash
#SBATCH --job-name=r62
#SBATCH --output=/lustre/scratch/client/movian/research/users/anhnd81/workspace/MomentumSMoE/result/r62_err.txt
#SBATCH --error=/lustre/scratch/client/movian/research//users/anhnd81/workspace/MomentumSMoE/result/r62.txt
#SBATCH --nodes=1
...
--nbatches 1000 \
--distributed \
--checkpoint /lustre/scratch/client/movian/research/users/anhnd81/workspace/MomentumSMoE/result/checkpoints/r62_1.pt \
"
