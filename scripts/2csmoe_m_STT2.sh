#!/bin/bash
#SBATCH --job-name=STT2
#SBATCH --output=/lustre/scratch/client/vinai/users/anhnd81/workspace/MomentumSMoE/result/2csmoe_STT2_err.txt
...
python -m torch.distributed.launch --master_port 10006 --nproc_per_node=2 --use_env train_STT2.py $args

echo "Evaluation ..."
# CUDA_VISIBLE_DEVICES='0,1' 
python -m torch.distributed.launch --master_port 10006 --nproc_per_node=2 --use_env train_STT2.py $args --resume --full-eval-mode
