#!/bin/bash
#SBATCH --job-name=rep
#SBATCH --output=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2csmoe_m_phi_err.txt
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2csmoe_m_phi.txt
#SBATCH --nodes=1
...
--nbatches 1000 \
--distributed \
--checkpoint /lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/checkpoints/2csmoe_m_phi.pt \
"
