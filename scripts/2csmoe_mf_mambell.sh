#!/bin/bash
#SBATCH --job-name=2csmoe_mfbell
#SBATCH --output=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2csmoe_mf_mambell_err.txt
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2csmoe_mf_mambell.txt
#SBATCH --nodes=1
