...
python -m torch.distributed.launch --master_port 10010 --nproc_per_node=1 --use_env train_2.py $args #\
# > >(tee -a /home/ubuntu/workspace/MomentumSMoE/result/smoe_s.txt) 2>&1

echo "Evaluation ..."
python -m torch.distributed.launch --master_port 10010 --nproc_per_node=1 --use_env train_2.py $args --resume --full-eval-mode #\ 
# > >(tee -a /home/ubuntu/workspace/MomentumSMoE/result/smoe_s.txt) 2>&1
