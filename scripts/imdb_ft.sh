mkdir -p /root/checkpoints/imdb/sym-m-test/
...
--checkpoint /root/checkpoints/imdb/sym-m-test/smoe.pt \
--resume 
"
# --wandb-flag \
...
echo "Training ..."
CUDA_VISIBLE_DEVICES='2' python -m torch.distributed.launch --master_port 10043 --nproc_per_node=1 --use_env /root/repos/SMoE_finetune/finetune_train.py $args 
