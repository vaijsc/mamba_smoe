#!/bin/bash
#SBATCH --job-name=mfull
#SBATCH --output=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2asmoe_mf_err.txt
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/2asmoe_mf.txt
#SBATCH --nodes=1
...
--nbatches 1000 \
--distributed \
--checkpoint /lustre/scratch/client/vinai/users/phinh2/workspace/MomentumSMoE/result/checkpoints/2asmoe_mf.pt \
"
