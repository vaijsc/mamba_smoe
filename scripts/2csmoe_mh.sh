...
--nbatches 1000 \
--distributed \
--checkpoint /lustre/scratch/client/vinai/users/anhnd81/workspace/MomentumSMoE/result/checkpoints/2csmoe_mh.pt \
"
...
python -m torch.distributed.launch --master_port 10011 --nproc_per_node=2 --use_env train_mh.py $args

echo "Evaluation ..."
# CUDA_VISIBLE_DEVICES='0,1' 
python -m torch.distributed.launch --master_port 10011 --nproc_per_node=2 --use_env train_mh.py $args --resume --full-eval-mode
