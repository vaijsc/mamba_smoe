...
python -m torch.distributed.launch --master_port 10012 --nproc_per_node=1 --use_env train_3.py $args

echo "Evaluation ..."
# CUDA_VISIBLE_DEVICES='0,1' 
python -m torch.distributed.launch --master_port 10012 --nproc_per_node=1 --use_env train_3.py $args --resume --full-eval-mode
