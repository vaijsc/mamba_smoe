...
echo "Training ..."
# CUDA_VISIBLE_DEVICES='0,1' 
python -m torch.distributed.launch --master_port 10018 --nproc_per_node=2 --use_env train_ft1.py $args2

echo "Evaluation ..."
# CUDA_VISIBLE_DEVICES='0,1' 
python -m torch.distributed.launch --master_port 10018 --nproc_per_node=2 --use_env train_ft1.py $args2 --resume --full-eval-mode
