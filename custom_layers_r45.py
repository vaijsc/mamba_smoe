...
import tree
from custom_functions_r45 import prepare_forward, prepare_forward_expert_choice ,ensure_comm
from custom_functions_r45 import MOEScatter, MOEGather
from custom_functions_r45 import AllGather, Slice
...
class FMoE(nn.Module):
    ...
    * `expert` can be specified as a module class, it is used to generate
    ...
    def forward(self, moe_inp):
        ...
        """
        # import ipdb; ipdb.set_trace()
        moe_inp_1, moe_inp_2, gate_top_k_idx_1, gate_score_1, gate_top_k_idx_2, gate_score_2, flag = self.gate(moe_inp)
        """
